...
import { ChevronDownIcon, ChevronUpIcon, PencilIcon, TrashIcon } from './Icons'; // NOVO: Importe PencilIcon e TrashIcon
      ...
      {isExpanded && (
        <div className="p-4 border-t border-slate-200 bg-slate-50 flex justify-between items-center">
          ...
          <div className="flex-shrink-0 flex space-x-2">
            {/* NOVO: Botão de Edição com Ícone */}
            <button
              onClick={() => onEdit(faq)}
            ...
            >
              <PencilIcon className="w-5 h-5" /> {/* Use o ícone aqui */}
            </button>
            {/* NOVO: Botão de Excluir com Ícone */}
            <button
            ...
            >
              <TrashIcon className="w-5 h-5" /> {/* Use o ícone aqui */}
            </button>
          </div>
        </div>
      )}
