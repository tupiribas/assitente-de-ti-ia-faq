...
//     const { question, answer, category, documentUrl, documentText } = req.body;
...
//         const newFaq = { id: uuidv4(), question, answer, category, documentUrl, documentText };
//         faqs.unshift(newFaq);
//         await saveFaqs(faqs);
...
// // Adicione esta rota para poder visualizar o log (com cautela em produção sem autenticação!)
...
// });
// tupiribas/assitente-de-ti-ia-faq/assitente-de-ti-ia-faq-7d4edb0208ca700cc4b23f02d8de99001e018975/server/index.js
// Carrega variáveis de ambiente do .env.local
// Esta linha deve ser a primeira para garantir que as variáveis de ambiente sejam carregadas antes de qualquer outra coisa.
require('dotenv').config({ path: require('path').resolve(__dirname, '..', '.env.local') });
